...
abstract class IPostService {
  ...
  Future<bool> putUtemToService(PostModel postModel, int id);
  Future<bool> deleteItem(int id);
  Future<List<PostModel>?> fetchPostItemsAdvance();
  Future<List<CommentModel>?> fetchReletadCommentsWithPostId(int postId);
}
...
class PostService implements IPostService {
  ...
  @override
  Future<bool> putUtemToService(PostModel postModel, int id) async {
    try {
  ...
  @override
  Future<List<CommentModel>?> fetchReletadCommentsWithPostId(int postId) async {
    try {
